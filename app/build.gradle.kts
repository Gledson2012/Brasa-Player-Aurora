...
android {
  namespace = "com.aistudio.musicplayer.qtzvka"
  compileSdk { version = release(36) { minorApiLevel = 1 } }

  defaultConfig {
    applicationId = "com.aistudio.musicplayer.qtzvka"
    minSdk = 24
    targetSdk = 36
    versionCode = 3
    versionName = "1.2.0"
  ...
  buildTypes {
    ...
    // Use the standard Android debug keystore so a clean checkout can build.
    debug { }
  }
  compileOptions {
